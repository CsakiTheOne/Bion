...
-- Script date 2020. 04. 22. 13:13:03
...
--
-- Create procedure `ThemeUpdateTextById`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE ThemeUpdateTextById(IN paramId INT, IN paramText TEXT)
BEGIN
UPDATE theme
SET theme.text = paramText
WHERE theme.id = paramId;
END
$$
...
--
-- Create procedure `CommentUpdateTextById`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE CommentUpdateTextById(IN paramId INT, IN paramText TEXT)
BEGIN
UPDATE comments
SET comments.text = paramText
WHERE comments.id = paramId;
END
$$

--
-- Create procedure `CommentDeleteByThemeId`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE CommentDeleteByThemeId(IN paramThemeId INT)
BEGIN
DELETE
  FROM comments
WHERE comments.themeId = paramThemeId;
...
--
-- Create procedure `CommentDeleteById`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE CommentDeleteById(IN `paramId` INT)
BEGIN
DELETE
  FROM comments
WHERE comments.id = paramId;
...
(17, '5e88bc3c4cd923.22759437', 'peldaaccount', '4df6e4cb7892366e8738ae7da861b3d9593ca5cc8d3c95784752b413636860a6', 'peldaaccount@peldaaccount', 0),
(18, '5e88bc858a1ad7.34344340', 'valaszaccount', '1791d121ffe541ef12f90d3d961d7549c2a1450b9725509948d75e3770945422', 'valaszaccount@valaszaccount.com', 0),
(19, '5ea002618c3712.13373601', 'b.richi1230@gmail.com', '3dbaa1faa39d9e5a7fd7b4a9dfc4058e0ca0a0c8d2b3a918553864317bcadac5', 'b.richi1230@gmail.com', 1),
(20, '5ea006dfe97890.97002713', 'asd', '688787d8ff144c502c7f5cffaafe2cc588d86079f9de88304c26b0cb99ce91c6', 'asd@asd.asd', 0);
